...
// Consume implements the transport itnerface, which will return read-only channel.
// for reading the incomming message received from another peer in the network.
func (t *TCPTransport) Consume() <-chan RPC {
	return t.rpcch
}

// Close implemets the transport Interface.
...
func (t *TCPTransport) ListenAndAccept() error {
	...
	log.Printf("TCP tranport listening on port: %s\n", t.ListenAddr)
